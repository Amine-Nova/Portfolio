...
const welcome = () => {
    return (
        <div className='flex item-baseline group cursor-default relative gap-3'>
            ...
            <div className='txt text-2xl font-bold tracking-wide bg-gradient-to-r from-slate-700 to-slate-600 bg-clip-text text-transparent group-hover:bg-gradient-to-r group-hover:tracking-widest transition-all ease-in-out duration-500 group-hover:from-slate-700 group-hover:via-slate-700 group-hover:to-amber-400 group-hover:bg-clip-text group-hover:text-transparent  hidden sm:flex items-center '>
                Greetings
