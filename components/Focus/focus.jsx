    ...
    <section className="fx-grid h-full flex flex-col sm:w-11/12 w-full xl:w-[80%] mx-auto mt-20 px-16 sm:px-5 xl:px-24 gap-4 z-20">
      ...
      <div className="w-full flex flex-col gap-4 z-20">
        <div className="flex w-full h-1/2 flex-col md:flex-row gap-4 z-20">
          <div className="group text-black flex flex-col justify-between rounded-3xl p-8 gap-3 cursor-pointer w-full md:w-7/12 bg-blue-400">
          ...
          <div className="flex flex-col group rounded-3xl p-8 gap-3 justify-between cursor-pointer w-full md:w-5/12 bg-blue-200">
        ...
        <div className="flex w-full h-1/2 flex-col md:flex-row gap-4 z-20">
          ...
          <div className="group flex gap-3 flex-col justify-between rounded-3xl p-8 cursor-pointer w-full md:w-7/12 bg-blue-500">
      ...
      <div className="group gap-2 rounded-3xl p-6 cursor-pointer flex flex-col justify-between md:items-center w-full mx-auto bg-blue-300">
