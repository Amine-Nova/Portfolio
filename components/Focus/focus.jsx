...
const Focus = () => {
  return (
    <section className="fx-grid min-h-[80vh] flex xl:flex-row flex-col sm:w-11/12 w-full xl:w-full mx-auto my-20 px-10 gap-4 z-20">
      ...
      <div className="w-full flex flex-col gap-4 z-20">
        <div className="flex w-full h-1/2 flex-col md:flex-row gap-4 z-20">
          <div className="group text-black flex flex-col justify-between rounded-3xl p-10 cursor-pointer w-full md:w-7/12 bg-blue-300">
            ...
            <p className="lg:text-base text-[12px] opacity-90 mt-2 lg:text-l">
              Learning is something I always focus on and strive to improve every day, constantly seeking new knowledge
            </p>
          </div>
          <div className="flex flex-col group rounded-3xl p-10 justify-between cursor-pointer w-full md:w-5/12 bg-blue-400">
        ...
        <div className="flex w-full h-1/2 flex-col md:flex-row gap-4 z-20">
          <div className=" flex flex-col  justify-between rounded-3xl p-10 cursor-pointer group w-full md:w-5/12 bg-blue-700 text-white">
            <svg
          ...
          <div className="group flex flex-col justify-between rounded-3xl p-10 cursor-pointer w-full md:w-7/12 bg-blue-100">
