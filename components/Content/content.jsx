...
const Content = () => {
  ...
  return (
    <div className="flex flex-col w-full items-center justify-center txt text-white lg:gap-1 min-h-[35em] sm:min-h-[28em] md:min-h-[50em] lg:min-h-[60em] 2xl:min-h-[calc(100vh-16rem)]">
